...
namespace WebJackpot.Controllers
{
    public class TriggeredJackpotsController : Controller
    {
        ...
        public TriggeredJackpotsController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var applicationDbContext = _context.TriggeredJackpots.Include(t => t.Jackpot);
        ...
        public async Task<IActionResult> Create([Bind("ID,JackpotID,UserId,CurrentWin,TriggerTime")] TriggeredJackpot triggeredJackpot)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,JackpotID,UserId,CurrentWin,TriggerTime")] TriggeredJackpot triggeredJackpot)
        {
